...
/*  Section #4:  AJAX code to send the HTTP Request, which is the location the user specifies, to the 
    ...
    Activity 1:  Add your APIXU API KEY in the code below.  This KEY can be retreived by visiting the 
                 ...
                 Use the following code as an example:
                     ...
                     url: 'https://api.apixu.com/v1/forecast.json?key=d5f6473529be44b1a82221813160608',
...
*/
        ...
        $(document).ready(function(){
           $(':button').click(function(){
                ...
                $.ajax({
                      type: 'GET',
                      url: 'http://api.apixu.com/v1/forecast.json?key=92a96e1fb1a24827adb231904160608&q=Paris',
                      data: message             
                })
                .done(function(json){
